    ...
    <div className="section-padding mt-20 min-h-[calc(100vh-9rem)]">
      <div className="wrapper">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-xl font-semibold tracking-wider">Our Commitment</h3>
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-xl font-semibold tracking-wider">Quality You Can Trust</h3>
            <p className="text-md font-light text-justify ">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-xl font-semibold tracking-wider">Shop with Confidence</h3>
            <p className="text-md font-light text-justify ">
          ...
          <p className="text-xl font-light text-justify ">Thank you for choosing Shoptronics — Where Innovation Meets Convenience.</p>
        </div>
      </div>
    </div>
  );
